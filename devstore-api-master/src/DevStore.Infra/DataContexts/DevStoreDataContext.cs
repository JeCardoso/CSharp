...
{
    /* Data context são conjunto de classe para acesso ao banco ORM, espelho do banco de dados */
    public class DevStoreDataContext : DbContext
    {
        public DevStoreDataContext()
            : base("DevStoreConnectionString")
        {
            /* Em tempo de desenvolvimento utilizado para iniciar o banco com informações */
            // Database.SetInitializer<DevStoreDataContext>(new DevStoreDataContextInitializer());
            /* Carrega sobre demanda em relacionamentos longos */
            Configuration.LazyLoadingEnabled = false;
            Configuration.ProxyCreationEnabled = false;
        }

        /* Traz um banco de dados virtual na memória */
        public DbSet<Product> Products { get; set; }
        public DbSet<Category> Categories { get; set; }

        /* Ao criar o banco adiciona esses configurações */
    ...
    {
        /* Alimenta o banco de dados a cada instancia */
        protected override void Seed(DevStoreDataContext context)
        {
            ...
            /* Submete as alterações para o banco de dados */
            context.SaveChanges();
