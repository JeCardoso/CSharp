...
{
    /* Habilita requisições apenas por origens fixas, tipos de headers e metodos */
    ...
    public class ProductController : ApiController
    {
        ...
        #region Products
        /* HTTPResponseMessage - Retorna uma mensagem(status) e mensagem */
        ...
        public HttpResponseMessage PatchProduct(Product product)
        {
            ...
            try
            {
                /* Avisa que o produto foi modificado */
